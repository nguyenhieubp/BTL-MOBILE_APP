...
let AttendanceService = class AttendanceService {
    constructor(userRepository, attendanceRepository) {
    ...
    async markAttendance(userId) {
        ...
        if (existingAttendance) {
            ...
            existingAttendance = new Attendance_entity_1.AttendanceEntity();
...
exports.AttendanceService = AttendanceService = __decorate([
    ...
    __param(1, (0, typeorm_1.InjectRepository)(Attendance_entity_1.AttendanceEntity)),
